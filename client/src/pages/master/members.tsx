                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary font-medium">
                      {member.phone?.charAt(0).toUpperCase() || member.name.charAt(0).toUpperCase()}
                    </div>
                    <div>
                      <p className="font-medium">{member.phone || member.name}</p>
                      <p className="text-xs text-muted-foreground">{member.bankName || "Belum ada bank"} {member.bankAccountNumber && `- ${member.bankAccountNumber}`}</p>
