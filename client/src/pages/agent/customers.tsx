                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary font-medium text-lg">
                      {customer.phone?.charAt(0).toUpperCase() || customer.name.charAt(0).toUpperCase()}
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <p className="font-medium">{customer.phone || customer.name}</p>
                        {customer.isLocked && (
                      ...
                      <div className="flex flex-col gap-1 mt-1">
                        <span className="flex items-center gap-1 text-sm text-muted-foreground">
                          {customer.bankName || "Belum ada bank"} {customer.bankAccountNumber && `- ${customer.bankAccountNumber}`}
                        </span>
                        {customer.email && (
                          <span className="flex items-center gap-1 text-sm text-muted-foreground">
